...
StaticPopupDialogs["APPEARANCE_BUDDY_WOWHEAD_URL_DIALOG"] = {
    text = "APPEARANCE_BUDDY_WOWHEAD_URL_DIALOG",
    button1 = "Version",
    button2 = CLOSE,
    timeout = 0,
    whileDead = true,
    ...
    OnAccept = function(self)
        ...
        StaticPopup_Hide("APPEARANCE_BUDDY_WOWHEAD_URL_DIALOG")
    end,
    ...
    OnHide = function(self)
        if not self.data.isClosed then
            StaticPopup_Show("APPEARANCE_BUDDY_WOWHEAD_URL_DIALOG", nil, nil, self.data)
        end
    end,
...
function ns.ShowWowheadURLDialog(itemId)
    if StaticPopup_Visible("APPEARANCE_BUDDY_WOWHEAD_URL_DIALOG") then
        StaticPopup_Hide("APPEARANCE_BUDDY_WOWHEAD_URL_DIALOG")
    end
    local data = {
        ["isRetail"] = true,
    ...
    local dialog = StaticPopup_Show("APPEARANCE_BUDDY_WOWHEAD_URL_DIALOG", nil, nil, data)
end